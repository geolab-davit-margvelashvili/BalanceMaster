...
namespace BalanceMaster.SqlRepository.Migrations
{
    ...
    [Migration("20250213140647_RefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BalanceMaster.Identity.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BalanceMaster.Identity.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BalanceMaster.Identity.Models.RefreshToken", b =>
                {
                    b.HasOne("BalanceMaster.Identity.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BalanceMaster.Identity.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
